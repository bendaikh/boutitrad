<x-admin-layout title="{{ $commercial->name }}">
    <x-admin.list-page>
        ...
        <x-admin.data-table class="flex-1 min-h-0">
            <x-slot:header>Commandes récentes</x-slot:header>
            <thead><tr><th class="text-left">Réf.</th><th class="text-left">Client</th><th class="text-left">Statut</th><th class="text-right">Total</th></tr></thead>
