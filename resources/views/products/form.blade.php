    ...
    <div class="admin-product-form-toolbar {{ $formActive ? '' : 'bg-slate-100 dark:bg-slate-800/60' }}">
        <div class="flex items-center gap-3 min-w-0 flex-1">
            ...
            >
                ...
                @elseif($draftImageUrl)
                    <img src="{{ $draftImageUrl }}" alt="" class="w-full h-full object-cover">
                @else
            ...
            <div class="min-w-0 flex-1">
                ...
                <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                    <label
                        ...
                        class="inline-flex items-center rounded-md border border-brand-200 dark:border-brand-700 bg-brand-50 dark:bg-brand-900/40 px-2 py-0.5 text-[10px] font-medium text-brand-700 dark:text-brand-300 hover:bg-brand-100 dark:hover:bg-brand-900/60 transition-colors"
                        :class="!formActive && 'opacity-40 pointer-events-none'"
                    >
                        {{ $product?->imageUrl() || $draftImageUrl ? 'Changer photo' : 'Ajouter photo' }}
                    </label>
                    ...
                    @endif
                    <span class="text-[10px] text-slate-400">JPG, PNG, WebP · max. 5 Mo</span>
                    @if($draftImageUrl)
                        <span class="text-[10px] text-emerald-600 dark:text-emerald-400">Photo conservée</span>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="px-3 py-2.5 grid grid-cols-2 md:grid-cols-4 xl:grid-cols-12 gap-x-2 gap-y-2">
                <div class="col-span-1 xl:col-span-2">
                    ...
                    <input
                        ...
                        @if($formActive) required @endif
                        placeholder="ex. PR00001"
                        class="admin-product-form-input font-mono text-xs"
                    >
